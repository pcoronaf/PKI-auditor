/*
 * demo-login — comportamiento correcto, tras un inicio de sesion.
 *
 * El formulario de firma solo se sirve con una sesion valida (cookie HttpOnly),
 * como en una plataforma real. Una vez dentro, se comporta como demo-safe.
 *
